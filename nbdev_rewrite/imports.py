...
# Cell nr. 39; Comes from 'notebooks/00_export_v4.ipynb'
# This Flag allows anyone to know if this Module exists in their namespace
MODULE__IMPORTS__FLAG = None


# Cell nr. 40; Comes from 'notebooks/00_export_v4.ipynb'
...
# Cell nr. 42; Comes from 'notebooks/00_export_v4.ipynb'
def test_eq(a,b): assert a==b, f'{a}, {b}'


# Cell nr. 44; Comes from 'notebooks/00_export_v4.ipynb'
...
# Cell nr. 45; Comes from 'notebooks/00_export_v4.ipynb'
...
# Cell nr. 46; Comes from 'notebooks/00_export_v4.ipynb'
...
# Cell nr. 47; Comes from 'notebooks/00_export_v4.ipynb'
...
# Cell nr. 48; Comes from 'notebooks/00_export_v4.ipynb'
...
# Internal Cell nr. 49; Comes from 'notebooks/00_export_v4.ipynb'
...
# Cell nr. 52; Comes from 'notebooks/00_export_v4.ipynb'
def in_ipython():
...
# Cell nr. 53; Comes from 'notebooks/00_export_v4.ipynb'
def in_colab():
...
# Cell nr. 54; Comes from 'notebooks/00_export_v4.ipynb'
def in_notebook():
...
# Cell nr. 56; Comes from 'notebooks/00_export_v4.ipynb'
def num_cpus():
    "Get number of cpus"
...
# Cell nr. 57; Comes from 'notebooks/00_export_v4.ipynb'
...
# Cell nr. 58; Comes from 'notebooks/00_export_v4.ipynb'
...
# Cell nr. 59; Comes from 'notebooks/00_export_v4.ipynb'
...
# Cell nr. 60; Comes from 'notebooks/00_export_v4.ipynb'
...
# Cell nr. 62; Comes from 'notebooks/00_export_v4.ipynb'
class ReLibName():
...
# Cell nr. 64; Comes from 'notebooks/00_export_v4.ipynb'
...
# Cell nr. 65; Comes from 'notebooks/00_export_v4.ipynb'
def last_index(x, o):
