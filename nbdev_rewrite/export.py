...
__all__ = ['find_exports', 'unwrap_attr', 'read_nb', 'update_from_all_', 'legacy_parse_options', 'iter_comments', 'find_default_export', 'parse_options', 'keyword_parser', 'ExportCache', 'create_mod_file', 'not_private', 'notebook2script', 'kw_hide', 'parse_export', 'module2relpath', 'update_recursive', 'get_relpath_nb', 'KeywordParser', 'add_names', 'kw_export', 'find_names', 'OptionsTuple']
...
# Cell
# export
def get_relpath_nb(nb_name):
    nb_path = Config().nbs_path/f'{nb_name}'
    config_path = Config().config_file.parent
    return os.path.relpath(nb_path, config_path).replace('\\', '/')
...
def _notebook2script(fname=None, cells=None, silent=False, to_dict=False):
    ...
    for e, s in ec.items():
        ...
        warning = f'# AUTOGENERATED! DO NOT EDIT! File to edit: {get_relpath_nb(fname)} (unless otherwise specified).'
