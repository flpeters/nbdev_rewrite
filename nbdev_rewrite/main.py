...
def relative_path(file_path, relative_directory=None):
    relative_directory = Config().config_file.parent if (relative_directory is None) else relative_directory
