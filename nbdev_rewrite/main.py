...
__all__ = ['CellInfo', 'Config', 'DictLikeAccess', 'DictLikeRepr', 'ExportUnit', 'FileInfo', 'MODULE__MAIN__FLAG', 'MergedFileInfo', 'ScopeUnit', 'StackTrace', 'Traced', 'all_commands', 'async_load_notebooks', 'cmd2func', 'convert2py', 'crawl_directory', 'create_config', 'kw_default_exp', 'kw_export', 'merge_all', 'parse_all', 'parse_file', 'read_nb', 'register_command', 'set_main_report_options', 'write_all', 'write_file']
...
# Cell nr. 269
@Traced
def convert2py(recurse:bool=True, st:StackTrace=None) -> (bool, dict, dict):
