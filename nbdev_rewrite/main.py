...
__all__ = ['StackTrace', 'all_commands', 'cmd2func', 'crawl_directory', 'file_generator', 'find_names', 'init_config', 'init_lib', 'iter_comments', 'kw_default_exp', 'kw_export', 'load_and_parse_all', 'main', 'make_valid_path', 'merge_and_write_all', 'module_to_path', 'parse_comment', 'parse_file', 'read_nb', 'register_command', 'relativify_imports', 'set_main_report_options', 'traced', 'write_file']
...
# Cell nr. 179
@traced
def merge_and_write_all(parsed_files, st:StackTrace) -> bool:
    ...
    for to, state in export_files.items():
        write_file(to=to, state=state, st=st)
    return success
...
def main(origin_path:str=None, output_path:str=None, recurse:bool=True, st:StackTrace=None) -> bool:
    ...
    write_success = merge_and_write_all(parsed_files, st=st)
