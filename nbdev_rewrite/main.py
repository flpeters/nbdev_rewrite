...
# Cell nr. 113
@prefetch(max_prefetch=-1) # NOTE: max_prefetch is <= 0 means queue size is infinite
def file_generator(path:Path=Config().nbs_path, recurse:bool=True) -> (Path, dict):
